...
function install_topinfra_maven_into_existing_maven() {
    ...
    #shaded_jar_url="https://oss.sonatype.org/content/repositories/snapshots/top/infra/maven/topinfra-maven-dist/0.0.1-SNAPSHOT/topinfra-maven-dist-0.0.1-20190710.085622-33-shaded.jar";
